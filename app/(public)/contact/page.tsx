        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mb-16">
            ...
            <h1 className="font-display text-5xl sm:text-7xl font-black text-[#F5F5F5] mt-4 leading-tight">
              Get in <span className="text-[#C0152A]">Touch</span>
            </h1>
          </motion.div>
              ...
              <div className="bg-[#1A1A1A] rounded-2xl border border-white/5 p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="text-sm text-[#9A9A9A] mb-1 block">Company</label>
                      <Input
                        value={form.company}
            ...
            >
              <div className="bg-[#1A1A1A] rounded-2xl border border-white/5 p-8">
                ...
                <div className="space-y-4">
                  {locations.map((loc) => (
                    <div key={loc.city} className="flex items-start gap-3 p-3 rounded-xl hover:bg-white/5 transition-colors">
                      ...
                      <div>
                        ...
                        <p className="text-[#9A9A9A] text-xs">{loc.address}</p>
                      </div>
                    </div>
                  ))}
                </div>
